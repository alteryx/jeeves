...
#' 
#' @export
#' @param yxmc path to macro
#' @param saveToFile file to save config.xml to
writePluginConfig <- function(yxmc, saveToFile = NULL){
  x <- getIO(yxmc)
...
#' @export
#' @inheritParams writePluginConfig
#' @rdname writePluginConfig
yxmc2PluginConfig <- function(yxmc, saveToFile = NULL){
  .Deprecated('writePluginConfig')
  writePluginConfig(yxmc = yxmc, saveToFile = saveToFile)
}
